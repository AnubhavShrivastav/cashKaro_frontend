...
function FlashDeal() {
  ...
  return (
    <>
      ...
      <div className="flex justify-center my-3 md:my-5 relative w-full min-h-screen bg-cover bg-center bg-[url('/img/FlashDeal.png')]">
        ...
        <Slider {...settings} className="overflow-hidden mx-10 h-full w-full absolute">
          {Array.isArray(data.Data) && data.Data.map((img) => (
            <div className="mt-50">
              ...
              <img
                src={img.imageUrl}
                className="w-[410px] mx-6 mt-6 object-cover"
                alt={error}
              />
              ...
              <button className="mx-78 absolute bottom-6 cursor-pointer rounded-lg px-3 py-1 bg-blue-700 text-white font-bold text-lg">Grab deal</button>
        ...
        <button className="absolute cursor-pointer bottom-10 left-[40%] bg-gray-800 rounded-xl opacity-70 px-30 py-2 text-white font-extrabold text-xl">View All</button>
